...
: ${version:="7.1.0"}
: ${packs_dir:=/mnt/ei/wso2ei-7.1.0/micro-integrator}

./wso2update_darwin --username {{sub_username}} --password {{sub_password}} 2>&1 | tee ${updates_dir}/output.txt
